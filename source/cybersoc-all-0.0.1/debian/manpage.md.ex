% cybersoc-all(SECTION) | User Commands
%
% "September  5 2021"
...
cybersoc-all - program to do something

# SYNOPSIS

**cybersoc-all** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**cybersoc-all** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **cybersoc-all** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**cybersoc-all** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    cybersoc-all. See **foo.conf**(5) for further details.
...
**cybersoc-all** provides some return codes, that can be used in scripts:
...
University of Liverpool Cybersecurity Society <cybersecurity@society.liverpoolguild.org>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 University of Liverpool Cybersecurity Society
